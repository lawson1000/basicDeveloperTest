...
def gundeletion():
    while True:
        choizes = int(
            input("Would you like to format database or remove one infomation: (format=1 / remove=2 /exit=3) "))
        if choizes == 1:
...
def user_reg():
    ...
    while True:
        ...
        if age < 20:
            ...
            guns = {"ASSAULT": ["AK47", "KILO141", "M4", "M16", "AK117", "FFAR15", "ASVAL", "PEACEKEEPERMK2", "KRIG6",
                                "ODEN"],
                    "SNIPER": ["The Omega", "Voice of Reason", "Sniper Kin", "Fair Looker", "Sharpshooter Sort",
                               "With Intent", "Night Fall", "The Assassin"],
                    "SMG": ["MSMC", "AKS-74U (RUS-79U)", "Chicom", "HG40", "PDW-57", "Razorback", "Pharo", "GKS"],
                    "PISTOL": ["ALFA Defender", "Deer gun", "Davis Warner Infallible", "Dan Wesson", "2mm Kolibri",
                               "Barrett"],
